...
import { UsersWithAgencyAndSubAccountPermissionsSidebarOptions } from "@/lib/types";
import { useRouter } from "next/navigation";
import { useState } from "react";

export const columns: ColumnDef<UsersWithAgencyAndSubAccountPermissionsSidebarOptions>[] =
  [
    {
      accessorKey: "id",
      header: "",
...
interface CellActionsProps {
  rowData: UsersWithAgencyAndSubAccountPermissionsSidebarOptions;
}
