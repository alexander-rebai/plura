...
const AgencyDetails = ({ data }: Props) => {
  ...
  const handleSubmit = async (values: z.infer<typeof FormSchema>) => {
    try {
      ...
      toast({
        ...
        title: "Oops!",
        description:
          "Could not create your agency at the moment. Please try again later.",
      });
    }
  };
  ...
  const handleDeleteAgency = async () => {
    ...
    //WIP discontinue the subscription for the user/agency
    try {
      ...
      toast({
        ...
        description: "Failed to delete the agency. Please try again later.",
        variant: "destructive",
      });
    }
              ...
              {data?.id && (
                <div className="flex flex-col gap-2">
                  ...
                  <NumberInput
                    ...
                    placeholder="Clients/Subaccounts Goal"
                  />
                </div>
              )}
          ...
          {data?.id && (
            <div className="flex flex-col md:flex-row items-center justify-between rounded-lg border border-destructive gap-4 p-4 mt-4">
              <div className="text-muted-foreground">
                ...
                Subaccounts will no longer have access to funnels, contacts etc.
              </div>
              <AlertDialogTrigger
